  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.entries(errors).length === 0) {
      ...
      if (JSON.stringify(res.message) == '"LOGIN_SUCCESS"') {
        ...
        JSON.stringify(res.message) == '"INCORECT_PASSWORD"' ||
        JSON.stringify(res.message) == '"INCORECT_EMAIL"'
      ) {
        openModal();
      }
    } else {
    ...
    <div className='yellow-background signup'>
      ...
      <div className='dialog-bg center'>
        <div className='signup-background'>
          <img src='/nice-book-web/images/login.png'></img>
        </div>
        <div>
          ...
          <div className='signup-form'>
            ...
            <h5 className='subtitle'>
              ...
              <Link to='/signup' style={{ color: '#FCBD10' }}>
                Sign up
              </Link>
            </h5>
