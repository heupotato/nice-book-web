        ...
        <div className='header-component'>
          <div>
            <img
              ...
              src='/nice-book-web/images/Logo.png'
          ...
          <div className='header-component '>
            ...
            <input
              className='search-input form-control input-field-search'
              id='search'
            ...
            />
            <i
              className='fa fa-search icon-search fa-lg'
              onClick={handleSubmit}
            ></i>
          </div>
          <div className='dropdown'>
            <h6
              className='header-component left-component'
